...
export default function MsgSection() {
  ...
  return (
    <section className="relative">
      ...
      <div ref={myMsg} className="w-full space-y-1 text-[14px] pt-5">
        <div data-aos="zoom-in-right" className="w-full">
          <div className="relative bg-white ml-[20px] p-3 w-[240px] rounded-2xl border-[3px] border-black">
        ...
        <div data-aos="zoom-in-left" className="w-full flex flex-row-reverse">
          <div className="relative bg-[#FFEF5C] mr-[20px] p-3 w-[240px] rounded-2xl border-[3px] border-black">
            <p>안녕하세요 고객냄!</p>
        ...
        <div data-aos="zoom-in-right" className="w-full">
          <div className="relative bg-white ml-[20px] p-3 w-[260px] rounded-2xl border-[3px] border-black">
            <p>물건을 구매했는데 집에서 확인하니 상품이 파손되어 있어요! 어떻게 해야하죠?</p>
            <img 
              className="w-5 absolute -left-[19px] top-3"
              src="/svg/bubble_tail_white.svg" 
              alt="bubble_tail" />
