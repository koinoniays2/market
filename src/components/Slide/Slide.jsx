...
export default function Slide({ obj }) {
  ...
  return (
    <section className="relative">
      ...
      <div ref={imageContainer} className={`w-full absolute pt-[100px] duration-1000 bottom-[50px] md:bottom-[100px]  ${showImage} ${obj.title === "Quickly and Easily" ? 'w-[230px]' : 'w-[250px]' } md:w-[500px] `}>
      <img 
          src={obj.image} 
          alt={`${obj.title} Image`}
          className="w-full" 
